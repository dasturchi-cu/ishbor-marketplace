    ...
    <Popover.Root>
      <Popover.Trigger asChild>
        <button
          type="button"
          className={cn(
            "touch-target inline-flex items-center justify-center rounded-lg text-muted-foreground transition-default hover:bg-secondary hover:text-foreground focus-ring data-[state=open]:bg-primary/10 data-[state=open]:text-primary",
            className,
          )}
    ...
    <div className="fixed inset-0 z-[100] flex items-end justify-center p-4 sm:items-center">
      ...
      >
        <div className="border-b border-border px-4 py-3">
          ...
          <p className="text-xs text-muted-foreground">Qidiring yoki kategoriyadan tanlang</p>
        </div>
        <EmojiPickerPanel
          theme={theme}
          onSelect={(emoji) => {
