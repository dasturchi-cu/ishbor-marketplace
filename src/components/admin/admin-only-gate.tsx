...
import { getDefaultDashboard, loginWithCredentials, logout } from "@/lib/auth";
      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="mx-auto max-w-lg px-4 py-20 text-center">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            <span className="font-medium text-foreground">{user.fullName}</span> ({user.userType}) sifatida kirdingiz.
          </p>
          <div className="mt-8 flex flex-col gap-3">
            <Link
              to={getDefaultDashboard(user.userType)}
